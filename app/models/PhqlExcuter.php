    ...
    private function sql($table){
        ...
        case "lo_site":
            $sql="SELECT site_tb2.tweet,site_tb2.sender_name,site_tb2.account_name,site_tb2.time,site_tb2.tweet_id 
                ...
                LEFT OUTER JOIN \ArroganciA\Model\Iine\site_iine ON site_tb2.tweet_id =\ArroganciA\Model\Iine\site_iine.tweet_id
                WHERE user_id=:user_id:
        ...
        case "lo_service":
            $sql="SELECT service_tb2.tweet,service_tb2.sender_name,service_tb2.account_name,service_tb2.time,service_tb2.tweet_id 
                ...
                LEFT OUTER JOIN \ArroganciA\Model\Iine\service_iine ON service_tb2.tweet_id =\ArroganciA\Model\Iine\service_iine.tweet_id
                WHERE user_id=:user_id:
        ...
        case "lo_system":
            $sql="SELECT system_tb2.tweet,system_tb2.sender_name,system_tb2.account_name,system_tb2.time,system_tb2.tweet_id 
                ...
                LEFT OUTER JOIN \ArroganciA\Model\Iine\system_iine ON system_tb2.tweet_id =\ArroganciA\Model\Iine\system_iine.tweet_id
                WHERE user_id=:user_id:
        ...
        case "lo_game" :
           $sql="SELECT game_tb2.tweet,game_tb2.sender_name,game_tb2.account_name,game_tb2.time,game_tb2.tweet_id 
                ...
                LEFT OUTER JOIN \ArroganciA\Model\Iine\game_iine ON game_tb2.tweet_id =\ArroganciA\Model\Iine\game_iine.tweet_id
                WHERE user_id=:user_id:
